...
public class PollService extends IntentService {
    ...
    public static final String ACTION_SHOW_NOTIFICATION ="com.example.flickerphotocopy.SHOW_NOTIFICATION";
    public static final String PERM_PRIVATE = "com.example.flickerphotocopy.PRIVATE";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (query == null){
            ...
            items = new FlickrFetchr().fetchSearchPhotos(query);
        }
